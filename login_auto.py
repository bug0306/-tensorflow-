...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.graphicsView.setStyleSheet("background-color:cyan;border-image:url('qrc:back.jpg');")
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "登录".encode('utf-8'), None))
        self.label.setText(_translate("Dialog", "登录ID".encode('utf-8'), None))
        self.pb_login.setText(_translate("Dialog", "登录".encode('utf-8'), None))
        self.pb_signup.setText(_translate("Dialog", "注册".encode('utf-8'), None))
        self.cb_r.setText(_translate("Dialog", "记住我".encode('utf-8'), None))
