...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "对话".encode('utf-8'), None))
        self.pb_send.setText(_translate("Dialog", "发送".encode('utf-8'), None))
        self.pb.setText(_translate("Dialog", "...", None))
        self.rb_s.setText(_translate("Dialog", "服务器".encode('utf-8'), None))
        self.rb_c.setText(_translate("Dialog", "客户端".encode('utf-8'), None))
        self.pb_connect.setText(_translate("Dialog", "连接".encode('utf-8'), None))
