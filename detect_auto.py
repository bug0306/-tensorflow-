...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.graphicsView.setStyleSheet(_fromUtf8("background-color:cyan;border-image: url(:/newPrefix/back.jpg) 0 0 0 0 stretch stretch;"))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "检测".encode('utf-8'), None))
        self.rb1.setText(_translate("Dialog", "语音转手势".encode('utf-8'), None))
        self.rb2.setText(_translate("Dialog", "手势转语音".encode('utf-8'), None))
        self.pb_detect.setText(_translate("Dialog", "检测".encode('utf-8'), None))
        self.pb_login.setText(_translate("Dialog", "登录".encode('utf-8'), None))
        self.pb_send.setText(_translate("Dialog", "发送".encode('utf-8'), None))
